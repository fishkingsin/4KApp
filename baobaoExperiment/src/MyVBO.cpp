...
void MyVBO::setup(){
    ...
    for(int y = 0 ; y < height ;y+=step)
    {
        ...
        for (int x = 0; x < width; x+=step)
        {
            ...
            if( col%2==0  )
            {
                nw = nw.getRotated(0,ofVec3f( x+step*0.5, y + step*0.5, 0), ofVec3f(0,0,1));
                ne = ne.getRotated(0,ofVec3f( x+step*0.5, y + step*0.5, 0), ofVec3f(0,0,1));
                sw = sw.getRotated(0,ofVec3f( x+step*0.5, y + step*0.5, 0), ofVec3f(0,0,1));
                se = se.getRotated(0,ofVec3f( x+step*0.5, y + step*0.5, 0), ofVec3f(0,0,1));
            }
            else if( col%2==1 )
            {
